    ...
    return (
        <Grid container>
                ...
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="customized table">
                        ...
                        <TableRow>
                            ...
                            <StyledTableCell align="right">longeurs</StyledTableCell>
                            <StyledTableCell align="right">Largeurs</StyledTableCell>
                            <StyledTableCell align="right">Hauteurs</StyledTableCell>
            ...
            <Grid  xs alignItems="center">
                <Button color="primary" variant="contained">Nouveaux</Button>
            </Grid>
        </Grid>
    );
}
